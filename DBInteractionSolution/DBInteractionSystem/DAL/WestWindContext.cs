...
namespace DBInteractionSystem.DAL;

// Changing the access specifier for the WestWindContext class to internal will restrict
// its use to the DBInteractionSystem namespace.
...
//    IF YOU INCLUDED THE CONNECTION STRING WHEN COMPLETING THE REVERSE ENGINEERING, YOU MUST COMMENT THIS FOLLOWING CODE OUT AFTER 
//    YOU INCLUDE A CONNECTION STRING INTO YOUR appsettings.json FILE.
//    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=WestWind;Integrated Security=True;encrypt=false");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC0748CF6A0F");
        ...
        {
            entity.HasKey(e => e.ManifestItemID).HasName("PK__Manifest__9000192CA946735B");
        ...
        {
            entity.HasKey(e => e.ShipmentID).HasName("PK__Shipment__5CAD378D9F011D10");
